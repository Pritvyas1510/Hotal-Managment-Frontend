...
const Slider = () => {
  ...
  return (
    ...
    <div className="slider-container border-2 border-black h-[477px] rounded-2xl shadow-gray-400 shadow-2xl">
      <img src={images[currentIndex]} alt="Slider" className="slider-image w-[2500px] h-[477px] rounded-2xl shadow-gray-300 shadow-2xl" />
    </div>
    <div className="w-[500px] gap-y-5">
